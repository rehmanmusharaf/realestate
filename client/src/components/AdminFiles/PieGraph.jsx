...
// export default AdminFile;import React from "react";
...
const PieChartComponent = ({
  ...
  const totalProperties = addedProperties + soldProperties;
  const addedPercentage = ((addedProperties / totalProperties) * 100).toFixed(
    2
  );
  const soldPercentage = ((soldProperties / totalProperties) * 100).toFixed(2);
